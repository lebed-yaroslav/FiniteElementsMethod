...
public static partial class TriangleBasis
{
    public static class Lagrange
    {
        ...
        public static readonly IBasisFunction L1L1L1 = new TriangleLagrangeL1L1L1();
        /// <summary>L2L2L2 = 0.5 * (L2) * (3 * L2 - 1) * (3 * L2 - 2)</summary>
        public static readonly IBasisFunction L2L2L2 = new TriangleLagrangeL2L2L2();
        /// <summary>L3L3L3 = 0.5 * (L3) * (3 * L3 - 1) * (3 * L3 - 2)</summary>
        public static readonly IBasisFunction L3L3L3 = new TriangleLagrangeL3L3L3();
        /// <summary>L1L2L1 = 4.5 * (L1) * (L2) * (3 * L1 - 1)</summary>
        public static readonly IBasisFunction L1L2L1 = new TriangleLagrangeL1L2L1();
        /// <summary>L1L2L2 = 4.5 * (L1) * (L2) * (3 * L2 - 1)</summary>
        public static readonly IBasisFunction L1L2L2 = new TriangleLagrangeL1L2L2();
        /// <summary>L2L3L2 = 4.5 * (L2) * (L3) * (3 * L2 - 1)</summary>
        public static readonly IBasisFunction L2L3L2 = new TriangleLagrangeL2L3L2();
        /// <summary>L2L3L3 = 4.5 * (L2) * (L3) * (3 * L3 - 1)</summary>
        public static readonly IBasisFunction L2L3L3 = new TriangleLagrangeL2L3L3();
        /// <summary>L3L1L3 = 4.5 * (L3) * (L1) * (3 * L3 - 1)</summary>
        public static readonly IBasisFunction L3L1L3 = new TriangleLagrangeL3L1L3();
        /// <summary>L3L1L1 = 4.5 * (L3) * (L1) * (3 * L1 - 1)</summary>
        public static readonly IBasisFunction L3L1L1 = new TriangleLagrangeL3L1L1();
        /// <summary>L1L2L3 = 27.0 * (L1) * (L2) * (L3)</summary>
        public static readonly IBasisFunction L1L2L3 = new TriangleLagrangeL1L2L3();
    }
