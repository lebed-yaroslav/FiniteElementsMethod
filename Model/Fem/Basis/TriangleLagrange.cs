...
public static partial class TriangleBasis
{
    public static class Lagrange
    {
        ...
        public static readonly Polynomial2D L1L1L1 = new()
        {
            Summands = {
            [(3, 0)] = 4.5,
            [(2, 0)] = -4.5,
        ...
        public static readonly Polynomial2D L2L2L2 = new()
        {
            Summands = {
            [(0, 3)] = 4.5,
            [(0, 2)] = -4.5,
        ...
        public static readonly Polynomial2D L3L3L3 = new()
        {
            Summands = {
            [(0, 0)] = 1.0,
        ...
        public static readonly Polynomial2D L1L2L1 = new()
        {
            Summands = {
            [(2, 1)] = 13.5,
            [(1, 1)] = -4.5
        ...
        public static readonly Polynomial2D L1L2L2 = new()
        {
            Summands = {
            [(1, 2)] = 13.5,
            [(1, 1)] = -4.5
        ...
        public static readonly Polynomial2D L2L3L2 = new()
        {
            Summands = {
            [(0, 2)] = 18.0,
            [(0, 1)] = -4.5,
        ...
        public static readonly Polynomial2D L2L3L3 = new()
        {
            Summands = {
            [(0, 1)] = 9.0,
            [(1, 1)] = -22.5,
        ...
        public static readonly Polynomial2D L3L1L3 = new()
        {
            Summands = {
            [(1, 0)] = 9.0,
            [(2, 0)] = -22.5,
        ...
        public static readonly Polynomial2D L3L1L1 = new()
        {
            Summands = {
            [(2, 0)] = 18.0,
            [(1, 0)] = -4.5,
        ...
        public static readonly Polynomial2D L1L2L3 = new()
        {
            Summands = {
            [(1, 1)] = 27.0,
            [(2, 1)] = -27.0,
