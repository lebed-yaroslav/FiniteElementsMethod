...
public static partial class TriangleBasis
{
    ...
    public static readonly Polynomial2D L1 = new()
    {
        Summands = {
            [(1, 0)] = 1.0
        }
    ...
    public static readonly Polynomial2D L2 = new()
    {
        Summands = {
            [(0, 1)] = 1.0
        }
    ...
    public static readonly Polynomial2D L3 = new()
    {
        Summands = {
            [(0, 0)] = 1.0,
            [(1, 0)] = -1.0,
    ...
    public static readonly Polynomial2D L1L2 = new()
    {
        Summands = {
            [(1, 1)] = 1.0
        }
    ...
    public static readonly Polynomial2D L2L3 = new()
    {
        Summands = {
            [(1, 1)] = -1.0,
            [(0, 2)] = -1.0,
    ...
    public static readonly Polynomial2D L3L1 = new()
    {
        Summands = {
            [(1, 1)] = -1.0,
            [(2, 0)] = -1.0,
    ...
    public static readonly Polynomial2D L1L2L2SubL1 = new()
    {
        Summands = {
            [(1, 2)] = 1.0,
            [(2, 1)] = -1.0,
    ...
    public static readonly Polynomial2D L1L3L1SubL3 = new()
    {
        Summands = {
            [(3, 0)] = -2.0,
            [(2, 1)] = -3.0,
    ...
    public static readonly Polynomial2D L2L3L2SubL3 = new()
    {
        Summands = {
            [(2, 1)] = -1.0,
            [(1, 2)] = -3.0,
