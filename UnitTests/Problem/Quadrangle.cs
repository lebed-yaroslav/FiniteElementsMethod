...
""";
    ...
    [InlineData(сетка_на_6_элементов_произвольные_внутренние_точки_прямые_внешние)]
    [InlineData(четыре_внутренние_точки_произвольные_внутренние_точки_прямые_внешние)]
    [InlineData(сетка_4_внутренних_КЭ_произвольные_внутренние_ребра)]
    [InlineData(сетка_4_внутренних_КЭ_произвольные_все_ребра)]
