...
global using ParabolicSolver2D = Model.Model.Problem.ParabolicSolver<Telma.Vector2D, Telma.Vector1D, Model.Core.CoordinateSystem.MatrixOperations.Ops2X2>;
global using ParabolicSolver3D = Model.Model.Problem.ParabolicSolver<Telma.Vector3D, Telma.Vector2D, Model.Core.CoordinateSystem.MatrixOperations.Ops3X3>;
// Assembler
