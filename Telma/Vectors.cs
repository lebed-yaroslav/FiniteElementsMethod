...
public readonly struct Vector1D(double x) : IVectorBase<Vector1D>
{
    ...
    public Vector1D WithComponent(int i, double value) => i switch
    {
        0 => value,
        _ => throw new IndexOutOfRangeException($"Index i = {i}, out of range 0..={Dimensions - 1}")
    };
...
public readonly struct Vector2D(double x, double y) : IVectorBase<Vector2D>
{
    ...
    public Vector2D WithComponent(int i, double value) => i switch
    {
        0 => new(value, Y),
        1 => new(X, value),
        _ => throw new IndexOutOfRangeException($"Index i = {i}, out of range 0..={Dimensions - 1}")
...
public readonly struct Vector3D(double x, double y, double z) : IVectorBase<Vector3D>
{
    ...
    public Vector3D WithComponent(int i, double value) => i switch
    {
        0 => new(value, Y, Z),
        1 => new(X, value, Z),
        2 => new(X, Y, value),
